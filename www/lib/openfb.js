 ...
 * 
 * Release notes
 * 0.5.1: Changed sessionStorage to localStorage - by @RafaelAdao
 */
var openFB = (function () {
    ...
    // By default we store fbtoken in localStorage. This can be overridden in init()
     ...
     *  tokenStore: (optional) The store used to save the Facebook token. If not provided, we use localStorage.
